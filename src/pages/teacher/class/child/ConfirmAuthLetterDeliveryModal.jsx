...
const ConfirmAuthLetterDeliveryModal = ({ isOpen, handleLetterDelivery, reveivers, closeModal }) => {
    ...
    const filteredPeople = reveivers?.filter(({ first_name, last_name, email }) => (
    ...
    return (
        <WideModal
            title={"Potwierdzenie dostarczenia pisemnej zgody"}
            subtitle={"Potwierdź dostarczenie przez odbierającego upoważnienia na odbiór dziecka"}
            isOpen={isOpen}
            action_buttons={
                <>
...
export default ConfirmAuthLetterDeliveryModal